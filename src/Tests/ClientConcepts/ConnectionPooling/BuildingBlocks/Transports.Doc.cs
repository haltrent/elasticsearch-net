...
namespace Tests.ClientConcepts.ConnectionPooling.BuildingBlocks
{
	public class Transports
	{
		/**== Transports
		*
		* The `ITransport` interface can be seen as the motor block of the client. Its interface is deceitfully simple, yet
		* it's ultimately responsible for translating a client call to a response.
		*
