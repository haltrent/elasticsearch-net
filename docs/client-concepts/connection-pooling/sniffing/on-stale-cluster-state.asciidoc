...
IMPORTANT NOTE
==============
This file has been generated from https://github.com/elastic/elasticsearch-net/tree/5.x/src/Tests/ClientConcepts/ConnectionPooling/Sniffing/OnStaleClusterState.doc.cs. 
...
----
<1> a sniff is done first and it prefers the first node master node

<2> a sniff is done first and it prefers the first node master node
