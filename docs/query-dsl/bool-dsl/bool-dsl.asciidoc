...
----
<1> three queries ``&&``ed together using the Fluent API

<2> three queries ``&&``ed together using Object Initialzer syntax
...
----
<1> two queries with `!` operator applied, ``&&``ed together using the Fluent API

<2> two queries with `!` operator applied, ``&&``ed together using the Object Initializer syntax
